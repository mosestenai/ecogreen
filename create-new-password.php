...
<head>
  ...
  <body>
  <h1 align = "middle"><font color ="navy">EAZISTEY</font></h1><br><br>
	...
	<?php
	  ...
	  <label><font color="black">Enter your new password</font></label>
		   <input type="password" name="pwd" placeholder="Enter a new password,,"><br>
		   <label><font color="black">Repeat your new password</font></label>
		   <input type="password" name="pwd-repeat" placeholder="Repeat new password,,"></div>
