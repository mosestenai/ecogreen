 ...
 session_start();
  ...
  $query= "SELECT * FROM shops WHERE username='$fg' ";
...
echo '<form method="post" action="server.php"><br><div class="input-group">
  	...
  	</div><button type="submit" class="loginbtn" name="changeusername">change</button></form>';
}
if(isset($_GET['profile'])){
echo '<form method="post" action="server.php" enctype="multipart/form-data"><br><h4>Select an image;</h4>
<input type="file" name="fileToUpload" id="fileToUpload">
<br><button type="submit" class="loginbtn" name="changeprofile">change</button></form>';
}
...
echo '<form method="post" action="server.php"><br><div class="input-group">
  	...
  	</div><button type="submit" class="loginbtn" name="changepassword">change</button></form>';
}
  }}}
?>